...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with the provided administrator credentials and submit the form by clicking the 'Ingresar' button (index 58).
        ...
        # -> Click the 'Pasajeros' link (interactive element index 134) to open the passenger directory and verify passenger records are displayed.
        # link "Pasajeros"
