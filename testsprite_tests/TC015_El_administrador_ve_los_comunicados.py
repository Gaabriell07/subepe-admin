...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with the provided credentials and click the Ingresar (submit) button to sign in.
        ...
        # -> Wait for the login to finish and then navigate to http://127.0.0.1:5173/comunicados to verify announcements.
        await page.goto("http://127.0.0.1:5173/comunicados")
        try:
            await page.wait_for_load_state("domcontentloaded", timeout=5000)
        except Exception:
            pass
