...
async def run_test():
    ...
    try:
        ...
        # -> Fill the administrator email and password fields and submit the login form by clicking the 'Ingresar' button.
        ...
        # -> Click the 'Viajes' (Trips) link (interactive element index 135) to open the trips page and then verify the trip list is displayed.
        # link "Viajes"
